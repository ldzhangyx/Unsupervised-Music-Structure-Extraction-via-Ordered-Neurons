...
print(mode)
sys.stdout.flush()
parser = argparse.ArgumentParser(description='PyTorch Music Chord RNN/LSTM Language Model')
...
parser.add_argument('--philly', default=False,
...
model = model.RNNModel(args.model, args.emsize, args.emsize, args.nhid, args.chunk_size, args.nlayers,
